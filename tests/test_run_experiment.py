...
class TestRunExperimentValidation:
    ...
    def test_validation_logic(self):
        ...
        assert (
            malicious_auditor_num > num_auditors
...
class TestTwoStepSelection:
    ...
    def test_both_attack_types_independent(self):
        ...
        assert (
            malicious_auditor_idx[0] in auditor_indices
        )  # Malicious auditor is an auditor
        assert (
            malicious_auditor_idx[0] not in attacker_idx
        )  # Malicious auditor not a malicious agent
